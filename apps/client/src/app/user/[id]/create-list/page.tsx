...
import { GET_USER_LISTS } from '@/lib/graphql/queries'
...
export default function CreateListPage() {
  ...
  const [createList] = useMutation(CREATE_LIST, {
    refetchQueries: [{ query: GET_USER_LISTS, variables: { userId } }],
    onCompleted: data => {
      ...
      <div className="max-w-md mx-auto">
        <div className="bg-white rounded-lg shadow-md p-8">
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-gray-600">Create a new shopping list to organize your items</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex space-x-4">
              <Link href={`/user/${userId}/lists`} className="flex-1 btn btn-secondary text-center">
                Cancel
              </Link>
              <button
                type="submit"
